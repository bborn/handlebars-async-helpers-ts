import { appendContextPath, createFrame, blockParams, isPromise } from '../utils';
import { Readable } from 'stream';

export default function(handlebars: any) {
  handlebars.registerHelper('each', async function(this: any, context: any, options: any) {
    if (!options) {
